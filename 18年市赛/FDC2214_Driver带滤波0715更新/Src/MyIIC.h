...
//IO方向设置
#define MyIIC_SDA_IN()  {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=8<<12;}
#define MyIIC_SDA_OUT() {GPIOB->CRH&=0XFFFF0FFF;GPIOB->CRH|=3<<12;}

//IO操作函数	 
#define MyIIC_SCL    PBout(10) 		//SCL
#define MyIIC_SDA    PBout(11) 		//SDA	 
#define MyIIC_READ_SDA   PBin(11) 		//输入SDA 
