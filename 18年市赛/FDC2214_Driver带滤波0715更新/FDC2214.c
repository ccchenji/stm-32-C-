...
uint8_t FDC2214_Init(void)
{
    ...
    {
        FDC2214_Reset();
        FDC2214_SetRcount(FDC2214_Channel_2, 1000);//400us 转换周期
        FDC2214_SetSettleCount(FDC2214_Channel_2, 100);//100 cycles 等待时间
        ...
        FDC2214_SetMUX_CONFIG(0, 0, FDC2214_Bandwidth_10M);//关闭自动扫描，10MHz带宽
