...
uint8_t FDC2214_Init(void)
{
    ...
    {
        FDC2214_Reset();
        FDC2214_SetRcount(FDC2214_Channel_0, 0x04d6);//2000us 转换周期
        FDC2214_SetRcount(FDC2214_Channel_1, 0x04d6);//2000us 转换周期
        FDC2214_SetRcount(FDC2214_Channel_2, 0x04d6);//2000us 转换周期
        FDC2214_SetRcount(FDC2214_Channel_3, 0x04d6);//2000us 转换周期
        ...
        FDC2214_SetChannelClock(FDC2214_Channel_0, 1, 1);//设置时钟分频，1分频，40MHz
        ...
        FDC2214_SetCurrentMode(0);//低功率激活模式
        FDC2214_SetClockSource(1);//外部时钟源
        FDC2214_SetHighCurrentMode(1);//正常电流传感器驱动
        FDC2214_SetMUX_CONFIG(0, FDC2214_Channel_Sequence_0_1_2_3, FDC2214_Bandwidth_10M);//关闭自动扫描，10MHz带宽
        FDC2214_SetDriveCurrent(FDC2214_Channel_0, FDC2214_Drive_Current_0_307);//通道0驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_1, FDC2214_Drive_Current_0_228);//通道1驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_2, FDC2214_Drive_Current_0_228);//通道2驱动电流0.081mA
        FDC2214_SetDriveCurrent(FDC2214_Channel_3, FDC2214_Drive_Current_0_228);//通道3驱动电流0.081mA
