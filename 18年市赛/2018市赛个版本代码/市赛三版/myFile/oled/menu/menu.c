...
_Menue(mode1Page, "MODEI", &firstPage,
	{
		...
		Show_Text(3,"handFlag:%d",handFlag);
		Change_Data(3,&handFlag);
	  if(handFlag>1)handFlag=1;else if(handFlag<0)handFlag=0;
	})
...
_Menue(studyPage, "study", &firstPage,
	{
		Set_Courese(10);
		Show_Text(1,"baseData:%d",lineBaseData.line1.nodeData);
	  Show_Text(2,"stoneErr:%d",lineBaseData.line2.nodeData);
		Show_Text(3,"clothErr:%d",lineBaseData.line3.nodeData);
		Show_Text(4,"shearErr:%d",lineBaseData.line4.nodeData);
		Show_Text(5,"oneErr:%d",lineStoneErr.line1.imDegree);
		Show_Text(6,"twoErr:%d",lineStoneErr.line2.imDegree);
		Show_Text(7,"threeErr:%d",lineStoneErr.line3.imDegree);
		Show_Text(8,"fourErr:%d",lineStoneErr.line4.imDegree);
