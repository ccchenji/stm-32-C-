...
_Menue(studyPage, "study", &firstPage,
	{
		Set_Courese(10);
		Show_Text(1,"baseData:%d",tBaseData.data1);
	  Show_Text(2,"stoneErr:%d",allStoneErr);
		Show_Text(3,"clothErr:%d",allClothErr);
		Show_Text(4,"shearErr:%d",allShearErr);
		Show_Text(5,"oneErr:%d",allOneErr);
		Show_Text(6,"twoErr:%d",allTwoErr);
		Show_Text(7,"threeErr:%d",allThreeErr);
		Show_Text(8,"fourErr:%d",allFourErr);
		Show_Text(9,"fiveErr:%d",allFiveErr);
