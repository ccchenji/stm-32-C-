...
#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOE,GPIO_Pin_0)//DIN
#define OLED_SDIN_Set() GPIO_SetBits(GPIOE,GPIO_Pin_0)

#define OLED_RST_Clr() GPIO_ResetBits(GPIOE,GPIO_Pin_2)//RES
...
void OLED_ShowNum2(u8 x,u8 y,u32 num,u8 len,u8 size);
...
int float_d(float area);
int float_i(float area);
void OLED_ShowNum_float(u8 x,u8 y,float area);
#endif  
